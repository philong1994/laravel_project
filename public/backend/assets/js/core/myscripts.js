...
function addImage() {
    ...
    html += '  <td class="text-left"><a id="thumb-image' + image_row + '"data-toggle="image" class="img-thumbnail"><img class="upload-image" src="http://localhost:8000/backend/assets/images/upload.png" id="img-detail-' + image_row + '" width="100px" height="100px" /><input type="hidden" name="post_image[' + image_row + '][image]" value="" id="input-image-' + image_row + '" /></td>';
...
$(document).ready(function() {
    ...
    $("#main-image,#main-image-error").click(function(event) {
        var eleImg = $(this).attr('id');
        var elmInput = $(this).next().attr('id');
        selectFileWithCKFinder('#'+eleImg,'#'+elmInput);
        event.preventDefault();
