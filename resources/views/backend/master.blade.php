...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('backend/assets/css/icons/icomoon/styles.css') }}" />
	<link rel="stylesheet" type="text/css" href="{{ asset('backend/assets/css/bootstrap.min.css') }}" />
	<link rel="stylesheet" type="text/css" href="{{ asset('backend/assets/css/core.min.css') }}" />
	...
	<!-- Theme JS files -->
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/editors/ckeditor/ckeditor.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/editors/ckfinder/ckfinder.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/core/app.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/core/layout.js') }}"></script>
	<!-- /theme JS files -->
</head>
...
<body>
	...
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/forms/inputs/maxlength.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/forms/styling/switch.min.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/forms/inputs/passy.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/jquery-number-master/jquery.number.min.js') }}"></script>
	...
	<script type="text/javascript" src="{{ asset('backend/assets/js/plugins/tables/datatables/extensions/buttons.min.js') }}"></script>
	...
	<script type="text/javascript" src="{{ asset('backend/assets/js/core/myscripts.js') }}"></script>
	<script type="text/javascript" src="{{ asset('backend/assets/js/core/ajax.js') }}"></script>
	<!-- /theme JS files -->
